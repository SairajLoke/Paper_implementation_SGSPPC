...
NUMs_SHAPE = 500 #200  # 5000  #S in paper #5000 toomuch time on cpu should be more than the basis size ( for dim of usvt)
...
SORTED_POINTCLOUD_NPY_FILEPATH = f'C:/Users/Sairaj Loke/Desktop/Preimage/Preimage_Intern_Task/shapgen/point_cloud_matrices/sorted_ptcloud_3NxS_b{BASIS_SIZE}_nf{NUM_PT_FEATURES}_sk{SWAP_K}_iI{ITERS_I}_w{WIDTH}_ns{NUMs_SHAPE}.npy'
